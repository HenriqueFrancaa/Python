while True:
    ...
    # então seria preciso fazer o ciclo do 2, depois o de 3 e assim por diante, e qual desses vai ter o ciclo maior? 
    # eis a questão e qual é o tamanho do ciclo? é isso que vamos descobrir.
